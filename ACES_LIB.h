...
/*
__DEVICE__ inline float3 ADX_to_ACES( float3 ADX)
{
float2 LUT_1D[11] = 
{ {-0.19f, -6.0f},
{ 0.01f, -2.721718645f},
...
*/
__DEVICE__ inline float3 convertFromLinear( float3 aces) {
...
__DEVICE__ inline float3 convertToLinear( float3 aces) {
