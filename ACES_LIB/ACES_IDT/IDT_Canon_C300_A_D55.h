#ifndef __IDT_CANON_C300_A_D55_H_INCLUDED__
#define __IDT_CANON_C300_A_D55_H_INCLUDED__
...
__DEVICE__ inline float3 IDT_Canon_C300_A_D55( float3 In)
{
	...
	aces.x =  Clip(0.561538969f * lin.x + 0.402060105f * lin.y + 0.036400926 * lin.z);
	aces.y =  Clip(0.092739623f * lin.x + 0.924121198f * lin.y - 0.016860821 * lin.z);
	aces.z =  Clip(0.084812961f * lin.x + 0.006373835f * lin.y + 0.908813204 * lin.z);
