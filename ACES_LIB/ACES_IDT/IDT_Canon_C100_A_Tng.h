#ifndef __IDT_CANON_C100_A_TNG_H_INCLUDED__
#define __IDT_CANON_C100_A_TNG_H_INCLUDED__

//
// ACES IDT for Canon EOS C100 (Type A)
//
...
__DEVICE__ inline float3 IDT_Canon_C100_A_Tng( float3 In)
{
	...
	aces.x =  Clip(0.566996399f * lin.x + 0.365079418f * lin.y + 0.067924183f * lin.z);
	aces.y =  Clip(0.070901044f * lin.x + 0.880331008f * lin.y + 0.048767948f * lin.z);
	aces.z =  Clip(0.073013542f * lin.x - 0.066540862f * lin.y + 0.99352732f * lin.z);
