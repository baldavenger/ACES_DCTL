#ifndef __ODT_REC2020_100NITS_DIM_H_INCLUDED__
#define __ODT_REC2020_100NITS_DIM_H_INCLUDED__

// 
// Output Device Transform - Rec2020
//

__DEVICE__ float3 inline ODT_Rec2020_100nits_dim( float3 oces)
{
